...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
      ...
      */
        System.out.println(MyUtil.calculateBMI(1, 2));
        System.out.println(MyUtil.average(5, 4, 3));
    ...
    static void work04UseOfObjectClass() {
      ...
      */
        ...
        BankAccount account = new BankAccount(123, p1);
        BankAccount account1 = new BankAccount(12, p2);
        ...
        Person accountOwner = new Person(1);
        BankAccount myAccount = new BankAccount(111, accountOwner);

        double depBalance = myAccount.deposit(120.0);
        System.out.println(depBalance);
    }
}
